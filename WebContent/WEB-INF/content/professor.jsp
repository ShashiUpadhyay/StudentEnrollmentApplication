...
<html>
    ...
    <body>        
        ...
        <br/>
        <br/>
        <div class="col-lg-6 col-lg-offset-3" style="width:1000px; height: 100px; text-align: left" align="center">
            <div class="well">
                <div class="container">
                    <div>
                    <h3><strong>Professor Information</strong></h3>                    
                </div>
                </div>                
            </div>
        </div>

        <div class="col-lg-6 col-lg-offset-3" style="width:1000px;" align="center">
            <div class="well">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">                            

                            <display:table export="true" id="professorlist" name="professorlist" pagesize="10" style="width:900px" 
                                ...
                                <display:column property="DEPT" title="Course" sortable="true"/>
                                <display:column property="COURSEID" title="Course" sortable="true"/>
                                <display:column property="EMAILADDRESS" title="Email Address" sortable="true"/>
                            </display:table>                            
                            <br/>                            
                            <div class="col-lg-9 col-lg-offset-3" style="alignment-adjust: central">
