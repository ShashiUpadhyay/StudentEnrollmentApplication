...
<br/>
        ...
        <div class="col-lg-6 col-lg-offset-3" style="width:900px; height: 100px; text-align: left" align="center"> 
            <div class="well">
                <div class="container">
                    <div>
                        <h3><strong>Department Information</strong></h3>                    
                </div>
                </div>                
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">                            
                            ...
                            <display:table export="true" id="departmentlist" name="departmentlist" pagesize="10" style="width:750px" 
                                           requestURI="" sort = "list">
                                <display:column property="DEPARTMENT_NAME" title="Department Name" sortable="true"/>
                                <display:column property="BUILDING" title="Location" sortable="true"/>
                                <display:column property="DEPARTMENT_INTAKE" title="Department Intake" sortable="true"/>                                
                            </display:table>                            
                            <br/>                            
