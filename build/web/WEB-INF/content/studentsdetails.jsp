    ...
    <body>        
        ...
        <div class="col-lg-6 col-lg-offset-3" style="width:900px; height: 100px; text-align: left" align="center">
            <div class="well">
                <div class="container">
                    <div>
                    <h3><strong>Enrolled Student Information</strong></h3>          
                    </div>
            </div>
        </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">                            
                            ...
                            <display:table export="true" id="students" name="students" pagesize="10" style="width:800px;" 
                                           requestURI="" sort = "list">
                                <display:column property="ID" title="user Name" sortable="true"/>
                            ...
                            <div class="col-lg-9 col-lg-offset-3">
                                <div align="center"><a class="btn btn-primary" href="visithomepage">Click! If want to Explore more » </a> </div>                                       
                            </div>
                        </div>
                    </div>
                </div>
